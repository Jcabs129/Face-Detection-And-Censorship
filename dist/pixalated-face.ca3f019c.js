...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pixalated-face.js":[function(require,module,exports) {
/*
...
function drawFace(face) {
  const {
    ...
    top,
    left
  } = face.boundingBox; // .clearRect will erase the previous wid/height of faceDetect 

  ctx.clearRect(0, 0, canvas.width, canvas.height);
  ctx.strokeStyle = '#ffc600';
  ctx.lineWidth = 2; // .strokeRect method is a way of drawing a rectangle
...
function censor({
  ...
  face.y, options.SIZE, options.SIZE); // Draw the face back on, but scale up
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","pixalated-face.js"], null)
//# sourceMappingURL=/pixalated-face.ca3f019c.js.map